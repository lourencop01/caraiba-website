        ...
        <div className="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory lg:grid lg:grid-cols-4 lg:overflow-visible lg:pb-0">
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="group relative bg-background rounded-2xl border border-border/30 overflow-hidden flex-shrink-0 w-[220px] sm:w-[260px] lg:w-auto snap-start hover:shadow-theme-lg transition-all duration-300"
              >
                {/* Image */}
